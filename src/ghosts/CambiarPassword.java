...
public class CambiarPassword extends javax.swing.JFrame {
     ...
     */
    public CambiarPassword(Login login, Player player) {
        initComponents();
        this.login=login;
        this.player=player;
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(51, 51, 51)
                .addComponent(lblUsuarioLogeado, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String user = player.usuarioLogeado;
        String contrasena = new String(txtContraActual.getText());

        Usuarios aux = player.buscarUsuario(user,0);
